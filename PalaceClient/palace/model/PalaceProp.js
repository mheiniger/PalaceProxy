...
util.inherits(PalaceProp, EventDispatcher);
	...
	function PalaceProp() //extends EventDispatcher
	{
        var that = this;

		this.asset/* :PalaceAsset */ = null;
		this.width/* :int */= 0;
		this.height/* :int */= 0;
		...
		var PalaceProp = this.PalaceProp = function(guid/* :String */, assetId/* :uint */, assetCrc/* :uint */)
		{
			that.asset = new PalaceAsset();
            that.asset.id = assetId;
            that.asset.crc = assetCrc;
...
//			trace("PaddedName: \"" + paddedName + "\" length: " + paddedName.length);
		...
		function encodeS20BitProp()/* :ByteArray */ {
			...
			var bm/* :FlexBitmap */ = FlexBitmap(that.getBitmap());
