...
//		[Bindable(event="selectedUserChanged")]
		...
		var addLooseProp = this.addLooseProp = function(id/* :int */, crc/* :uint */, x/* :int */, y/* :int */, addToFront/* :Boolean */ = false)/* :void */ {
...
//			trace("Moving prop index " + index);
		...
		var whisper = this.whisper = function(userId/* :int */, message/* :String */, logMessage/* :String */ = null)/* :void */ {
			var user/* :PalaceUser */ = getUserById(userId);
			if (logMessage == null) {
				logMessage = message;
			}
